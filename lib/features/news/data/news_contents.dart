...
final aiNewsContents = [
  ...
  {
    'id': 'ai_4',
    'title': '[기획] 디지털 헬스케어 혁명, 의료의 미래를 바꾼다',
    'description':
        'AI 진단, 웨어러블 디바이스, 원격 의료까지... 급성장하는 디지털 헬스케어 시장을 해부한다. 개인 맞춤형 의료 서비스의 시대가 온다.',
    'imageUrl': 'https://picsum.photos/800/400?random=14',
  },
  {
    'id': 'ai_5',
    'title': '[특보] 우주 산업의 새로운 지평, 민간 우주여행 시대 개막',
    'description':
        '스페이스X, 블루오리진, 버진갤럭틱... 민간 우주기업들의 경쟁이 치열해지고 있다. 우주 관광에서 자원 채굴까지, 새로운 비즈니스의 가능성.',
    'imageUrl': 'https://picsum.photos/800/400?random=15',
  },
  {
    'id': 'ai_6',
    'title': '[집중조명] 그린 에너지 전환, 탄소중립으로 가는 길',
    'description':
        '재생에너지 확대, 수소경제 활성화... 2050 탄소중립을 향한 글로벌 에너지 혁신 현장을 점검한다. ESG 경영이 가져올 변화는?',
